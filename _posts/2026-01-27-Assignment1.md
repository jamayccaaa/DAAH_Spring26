...
![search](/image/Search.png "My Searches".)
![word cloud] (/image.WordCloudRMarkdown.png "R Markdown Word Cloud".)
...
![red highlights](/image/time-red.png "Time Red Highlights".)
...
![time](/image/time-.png "Time Collocates".)
